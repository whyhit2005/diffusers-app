...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="start id of new tokens inserted to the tokenizers per token_abstraction identifier when "
        "--train_text_encoder_ti = True. By default, i=0 "
        "tokens - <si> ",
    )
...
def main(args):
    ...
    if args.train_text_encoder_ti:
        ...
        token_idx = args.new_tokens_start_id
    ...
    def save_model_hook(models, weights, output_dir):
        ...
        if args.train_text_encoder_ti:
            embedding_handler.save_embeddings(f"{output_dir}/pytorch_lora_emb.safetensors")
    ...
    if accelerator.is_main_process:
        ...
        if args.train_text_encoder_ti:
            embeddings_path = f"{args.output_dir}/pytorch_lora_emb.safetensors"
        ...
        save_file(kohya_state_dict, f"{args.output_dir}/pytorch_kohya_weights.safetensors")
